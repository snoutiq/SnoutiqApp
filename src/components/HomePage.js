...
export default function DashboardScreen({ navigation }) {
  ...
  const [localUser, setLocalUser] = useState({ name: "", location: "Delhi" });
  ...
  const handleProfileComplete = () => {
    // This function will be called when the profile is completed
    loadUserData(); // Reload user data to reflect updated profile
  };
  ...
  return (
    <SafeAreaView style={styles.container}>
      {/* Render the ProfileCompletionModalAuto */}
      <ProfileCompletionModalAuto onComplete={handleProfileComplete} />
          ...
          <View style={styles.headerTop}>
            <View>
              ...
              <Text style={styles.userName}>
                {user?.name || localUser.name || "Pet Parent"}
              </Text>
            </View>
          ...
          <View style={styles.petStatusCard}>
            <View style={styles.petStatusContent}>
              ...
              <View style={styles.petInfo}>
                <Text style={styles.petName}>{user?.petName || pet.name}</Text>
